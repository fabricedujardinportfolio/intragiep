...
if ( ! function_exists( 'magazine_plus_footer_copyright' ) ) :
	...
	function magazine_plus_footer_copyright() {
		...
		// Powered by content.
		$powered_by_text = sprintf( __( '%s', 'magazine-plus' ), '<a target="_blank" rel="designer" href="https://giep.nc/">' . __( 'GIEP-NC', 'magazine-plus' ) . '</a>' );
				...
				<?php if ( has_nav_menu( 'top' ) ) : ?>
					<div id="top-nav">
						<button class="menu-toggle" aria-controls="top-menu" aria-expanded="false">
			          	<i class="fa fa-bars"></i>
			          	<i class="fa fa-close"></i>
						<?php esc_html_e( 'Amicale', 'magazine-plus' ); ?></button>
						<?php
							wp_nav_menu(
								array(
									'theme_location'  => 'top',
