...
if ( ! function_exists( 'magazine_plus_get_default_theme_options' ) ) :
	...
	function magazine_plus_get_default_theme_options() {
		...
		$defaults['ticker_title']          = esc_html__( 'Derniers articles', 'magazine-plus' );
		...
		// Footer.
		$defaults['copyright_text'] = esc_html__( 'Copyright &copy; Tous les droits sont réservés.', 'magazine-plus' );
