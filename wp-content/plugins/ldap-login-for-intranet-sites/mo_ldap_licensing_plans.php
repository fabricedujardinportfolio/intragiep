                        ...
                        <div class="row">
                            <div class="col span-1-of-2 steps-box">
                                <div class="works-step">
                                    <div>1</div>
                                    <p>
                                        Click on Upgrade Now and you will be redirected to miniOrange Login Console. Enter your login credentials and you will be redirected to our payment page.
                                    </p>
                                </div>
                                <div class="works-step">
                                    <div>2</div>
                                    <p>
                                        Enter you card details and complete the payment. On successful payment completion, you will see the link to download the premium plugin.
                                    </p>
                                </div>
                                <div class="works-step">
                                    <div>3</div>
                                    <p style="padding-top:10px;">
                                        Download the premium plugin. <br><br>
                                    </p>
                                </div>
                                <div class="works-step">
                                    <div>4</div>
                                    <p>
                                        From the Wordpress admin dashboard, delete the free plugin currently installed. <br>
                                    </p>
                                </div>
                            </div>
                            <div class="col span-1-of-2 steps-box">
                                <div class="works-step">
                                    <div>5</div>
                                    <p style="padding-top:10px;">
                                         Unzip the premium plugin and extract the files. <br><br><br>
                                    </p>
                                </div>
                                <div class="works-step">
                                    <div>6</div>
                                    <p>
                                        Upload the extracted files of premium plugin using FTP to path. <b><i>/wp-content/plugins/</i></b> Alternately, go to <b>Add New → Upload Plugin</b> in Plugin's menu to install the .zip directly.
                                    </p>
                                </div>
                                <div class="works-step">
                                    <div>7</div>
                                    <p style="padding-top:10px;">
                                        Activate plugin and login to the plugin with the miniOrange account. <br>
                                    </p>
                                </div>
                                <div class="works-step">
                                    <div>8</div>
                                    <p>
                                        From this point on, do not update the plugin from the Wordpress store. We will notify you when we upload a new version of the plugin.   
                                    </p>
                                </div>
                            </div>
                        </div>
