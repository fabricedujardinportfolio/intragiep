                ...
                <p><strong style="font-size:14px;">NOTE: </strong> You need to find out the values for the below given fields from your LDAP Administrator.</strong></p>
					<table class="mo_ldap_settings_table">
						...
						<tr>
                            ...
                            <td style="float: left;width:78%;"><div id="mo_ldap_directory_server_url" style="position: relative;"><table><tr><td style="width: 340px;"><input class="mo_ldap_table_textbox <?php echo $mo_ldap_local_server_url_status; ?>" type="text" id="ldap_server" name="ldap_server" style="width: 115%;margin-left: 7%" required placeholder="LDAP Server hostname or IP address" value="<?php echo $ldap_server_address?>" /></td><td></td></td></tr></table></div></td>
