<!-- The Modal -->
    <div id="moblc_feedback_modal" class="mo_modal" style="width:90%; margin-left:12%; margin-top:5%; text-align:center; margin-left;">
        ...
        <div class="mo_wpns_modal-content" style="width:50%;">
            ...
            <form name="f" method="post" action="" id="moblc_feedback">
                <?php wp_nonce_field("moblc_feedback");?>
                <input type="hidden" name="option" value="moblc_feedback"/>
					...
					<div style="text-align:center;">
						...
						<br><br>
						<textarea id="moblc_query_feedback" name="moblc_query_feedback" rows="4" style="width: 60%"
                    ...
                    <div class="mo-modal-footer" style="text-align: center;margin-bottom: 2%">
                        <input type="submit" name="moblc_feedback_submit"
                        ...
                        <input type="button" name="miniorange_skip_feedback"
                               style="background-color:#20b2aa; padding: 1% 3% 1% 3%;color: white;cursor: pointer;" value="Skip" onclick="document.getElementById('moblc_feedback_form_close').submit();"/>
                    </div>
                </div>
            ...
            <form name="f" method="post" action="" id="moblc_feedback_form_close">
                <?php wp_nonce_field("moblc_skip_feedback");?>
                <input type="hidden" name="option" value="moblc_skip_feedback"/>
            </form>
    ...
    <script>
        jQuery('a[aria-label="Deactivate miniOrange Broken Link Checker/Finder"]').click(function () {

            var mo_modal = document.getElementById('moblc_feedback_modal');
...
// When the user clicks the button, open the mo2f_modal
			...
			document.querySelector("#moblc_query_feedback").focus();
